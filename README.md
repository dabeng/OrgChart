...
- As its name implies, BigOrgChart is designed to display a huge organization chart including a number of nodes. In other words, BigOrgChart allows users to load nodes as needed rather than load all nodes all at once at the moment of instantiation.
