...
describe('orgchart -- integration tests', function () {
  ...
  fragment = '<div class="orgchart"><table><tr><td colspan="4"><div id="n1" class="node">' +
    '<div class="title"><i class="oc oc-leader symbol"></i>Lao Lao</div><i class="edge verticalEdge bottomEdge oc"></i></div>' +
    ...
    '<div id="n2" data-parent="n1" class="node"><div class="title">Bo Miao</div><i class="edge verticalEdge topEdge oc"></i>' +
    '<i class="edge horizontalEdge rightEdge oc"></i><i class="edge horizontalEdge leftEdge oc"></i></div></td></tr></table></td>' +
    '<td colspan="2"><table><tr><td><div id="n3" data-parent="n1" class="node"><div class="title">Su Miao</div>' +
    '<i class="edge verticalEdge topEdge oc"></i><i class="edge horizontalEdge rightEdge oc"></i>' +
    '<i class="edge horizontalEdge leftEdge oc"></i></div></td></tr></table></td></tr></table></div>',
  oc = {};
  ...
  describe('init()', function () {
    ...
    context('initialize chart with various combinations of "visibleLevel" and "verticalLevel" ', function () {
      ...
      it('verticalLevel=2 and visibleLevel=1', function () {
        var fragment = '<div class="orgchart"><table><tr><td colspan="4"><div class="node"><div class="title"><i class="oc oc-leader symbol"></i>Lao Lao</div>' +
          '<i class="edge verticalEdge bottomEdge oc"></i></div></td></tr><tr class="verticalNodes hidden"><td><ul><li><div class="node slide-up">' +
          '<div class="title">Bo Miao</div></div></li><li><div class="node slide-up"><div class="title">Su Miao</div>' +
          '<i class="toggleBtn oc oc-plus-square"></i></div><ul class="hidden"><li><div class="node slide-up"><div class="title">Tie Hua</div></div></li>' +
      ...
      it('verticalLevel=2 and visibleLevel=2', function () {
        var fragment = '<div class="orgchart"><table><tr><td colspan="4"><div class="node"><div class="title"><i class="oc oc-leader symbol"></i>Lao Lao</div>' +
          '<i class="edge verticalEdge bottomEdge oc"></i></div></td></tr><tr class="verticalNodes"><td><ul><li><div class="node">' +
          '<div class="title">Bo Miao</div></div></li><li><div class="node"><div class="title">Su Miao</div><i class="toggleBtn oc oc-plus-square"></i></div>' +
      ...
      it('verticalLevel=2 and visibleLevel=3', function () {
        var fragment = '<div class="orgchart"><table><tr><td colspan="4"><div class="node"><div class="title"><i class="oc oc-leader symbol"></i>Lao Lao</div>' +
          '<i class="edge verticalEdge bottomEdge oc"></i></div></td></tr><tr class="verticalNodes"><td><ul><li><div class="node">' +
          '<div class="title">Bo Miao</div></div></li><li><div class="node"><div class="title">Su Miao</div><i class="toggleBtn oc oc-minus-square"></i></div>' +
